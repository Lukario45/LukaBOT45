package com.Lukario45.LukaBot45.stable;
...
public class Bot extends ListenerAdapter {
    ...
    public void onMessage(MessageEvent e) {
        ...
        //System.
        if (e.getMessage().startsWith(Config.PUBLIC_IDENTIFIER) || e.getMessage().startsWith(Config.NOTICE_IDENTIFIER) || e.getMessage().toLowerCase().startsWith(e.getBot().getNick().toLowerCase() + ", ")) {
            ...
            if (command.equalsIgnoreCase("newdef")) {
                Commands.newDefine(e);
            }
            if (command.equalsIgnoreCase("define")) {
                Commands.define(e);
            }
            if (command.equalsIgnoreCase("deldef")) {
                Commands.delDefine(e);
            }
            if (command.equalsIgnoreCase("urban")) {
                Commands.urban(e);
            }
